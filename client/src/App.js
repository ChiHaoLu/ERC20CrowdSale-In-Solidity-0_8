...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>KilliFish Token Sale</h1>
        <p>Get Your Tokens Today!</p>
        <h2>KYC WhiteListing</h2>
        Address to allow: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handelInputChange}/>
        <button type="button" onClick={this.handelKycWhiteListing}>Add to WhiteList</button>

        <h2>Buy Tokens!</h2>
        <p>If you want to but tokens, send Wei to this address: {this.state.tokenSaleAddress}</p>

        <p>Your Currently have: {this.state.userTokens} KF Tokens</p>
